...
WebUI.click(findTestObject('Object Repository/Page_L Tm Anh Log in to the site/div_Username'))

WebUI.click(findTestObject('Object Repository/Page_L Tm Anh Log in to the site/input_Username_username'))
