...
WebUI.click(findTestObject('Object Repository/Page_Edit questions/label_TrueFalse                            _836f0e'))

WebUI.click(findTestObject('Object Repository/Page_Edit questions/input_Description_submitbutton'))

WebUI.setText(findTestObject('Object Repository/Page_Editing a TrueFalse question/input_Question name_name'), 'Anh le la ai')

WebUI.setText(findTestObject('Object Repository/Page_Editing a TrueFalse question/div_Anh le la ai'), '<p dir="ltr" style="text-align: left;" id="yui_3_17_2_1_1641726640458_1708">Anh le la ai</p>')

WebUI.scrollToElement(findTestObject('Object Repository/Page_Editing a TrueFalse question/input__submitbutton'), 0)
