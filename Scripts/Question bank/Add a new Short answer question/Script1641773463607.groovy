...
WebUI.click(findTestObject('Object Repository/Page_Edit questions/input_Matching_qtype'))

WebUI.click(findTestObject('Object Repository/Page_Edit questions/input_Description_submitbutton'))

WebUI.setText(findTestObject('Object Repository/Page_Editing a Short answer question/input_Question name_name'), 'Anh le la ai')

WebUI.setText(findTestObject('Object Repository/Page_Editing a Short answer question/div_Anh le la ai'), '<p dir="ltr" style="text-align: left;" id="yui_3_17_2_1_1641726965698_2888">Anh le la ai</p>')

WebUI.scrollToElement(findTestObject('Object Repository/Page_Editing a Short answer question/input_Answer 1_answer0'), 0)

WebUI.setText(findTestObject('Object Repository/Page_Editing a Short answer question/input_Answer 1_answer0'), '1')

WebUI.selectOptionByValue(findTestObject('Object Repository/Page_Editing a Short answer question/select_None        100        90        83._8cdef3'), 
    '1.0', true)

WebUI.scrollToElement(findTestObject('Object Repository/Page_Editing a Short answer question/input__submitbutton'), 0)
