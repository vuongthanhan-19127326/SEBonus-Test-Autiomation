...
WebUI.click(findTestObject('Object Repository/Page_Dashboard/i_hello_icon fa fa-caret-right fa-fw'))

WebUI.click(findTestObject('Object Repository/Page_Dashboard/div_Student Two'))

WebUI.setText(findTestObject('Object Repository/Page_Dashboard/textarea_Use enter to send_yui_3_17_2_1_164_1c2d5d'), 'alo')
