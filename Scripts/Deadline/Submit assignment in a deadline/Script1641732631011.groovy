...
WebUI.scrollToElement(findTestObject('Object Repository/Page_1 Deadline 1 - Edit submission/input_Loading_submitbutton'), 
    0)

WebUI.click(findTestObject('Object Repository/Page_1 Deadline 1 - Edit submission/input_Loading_submitbutton'))
