...
WebUI.setText(findTestObject('Object Repository/Page_L Tm Anh Log in to the site/input_Username_username'), 'anhle1')
...
WebUI.click(findTestObject('Object Repository/Page_1 Deadline 1/button_Edit submission'))

WebUI.click(findTestObject('Object Repository/Page_1 Deadline 1 - Edit submission/i_- drag and drop not supported_icon fa fa-_ea7f6f'))
